...
# )
THINKING_PROCESS = '''
You first thinks about the reasoning process in the mind and then provides the user with the following function. 
The reasoning process and functions are enclosed within <think> </think> and <answer> </answer> tags, respectively, i.e.,
<think> reasoning process here </think><answer> function, i.e., pyautogui.click(x=0.797, y=0.219), here </answer>
'''
SYSTEM_PROMPT = agent_system_message + THINKING_PROCESS
